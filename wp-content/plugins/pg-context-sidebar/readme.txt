...
= Version 2.0.1 =
* Tested compatability with WordPress 3.8.1
* Added logic to stop the sidebar icon showing in post types where it had not been selected.
* Added the ability to exclude the copy functionallity from some post types (was failing for some blogs with a large number of posts)
